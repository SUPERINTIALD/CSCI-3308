...
function initializeEventModal() {
  ...
  EVENT_MODAL = new bootstrap.Modal(document.getElementById("event-modal"),"event-modal");
}
...
function updateLocationOptions(modality_value) {
  ...
  if(modality_value == "in-person"){
    ...
    remoteURL.style.display="inline";
    location.style.display="none";
    document.getElementById("remoteLabel").style.display = "inline";
